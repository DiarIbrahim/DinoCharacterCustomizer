...
#include "DinoCharacterCustomizerCameraSettings.generated.h"

USTRUCT(BlueprintType)
struct FDinoCharacterCustomizerCameraSettings
{
	GENERATED_BODY()
	...
	bool IsNearlyEqual(const FDinoCharacterCustomizerCameraSettings& Other, float Tolerance = .1f) const
	{
