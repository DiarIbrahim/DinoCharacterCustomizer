...
DEFINE_TAG(DinoCustomizationTags::CustomizableInstance_Instance_4, "CustomizableInstance.Instance4")
DEFINE_TAG(DinoCustomizationTags::CustomizableInstance_Instance_5, "CustomizableInstance.Instance5")
DEFINE_TAG(DinoCustomizationTags::CustomizableInstance_Instance_6, "CustomizableInstance.Instance6")


// sub domains

DEFINE_TAG(DinoCustomizationTags::CustomizableSubDomain_Material, "CustomizableSubDomain.material")


DEFINE_TAG(DinoCustomizationTags::CustomizableSubInstance_Instance_1, "CustomizableSubInstance.Instance1")
DEFINE_TAG(DinoCustomizationTags::CustomizableSubInstance_Instance_2, "CustomizableSubInstance.Instance2")
DEFINE_TAG(DinoCustomizationTags::CustomizableSubInstance_Instance_3, "CustomizableSubInstance.Instance3")
DEFINE_TAG(DinoCustomizationTags::CustomizableSubInstance_Instance_4, "CustomizableSubInstance.Instance4")
DEFINE_TAG(DinoCustomizationTags::CustomizableSubInstance_Instance_5, "CustomizableSubInstance.Instance5")
DEFINE_TAG(DinoCustomizationTags::CustomizableSubInstance_Instance_6, "CustomizableSubInstance.Instance6")
